...
@Component({
  ...
  template: `
    <div class="auth-container">
      <nz-card nzTitle="Sign In" class="auth-card">
        @if (error) {
          <nz-alert nzType="error" [nzMessage]="error" nzShowIcon></nz-alert>
        }
        <form nz-form (ngSubmit)="onSubmit()" #loginForm="ngForm">
          <nz-form-item>
          ...
          <nz-form-item>
            ...
            <nz-form-control [nzSpan]="18">
              <input nz-input type="password" [(ngModel)]="password" name="password" placeholder="Enter password" required />
            </nz-form-control>
          </nz-form-item>
          <nz-form-item>
            <nz-form-control [nzOffset]="6" [nzSpan]="18">
              <button nz-button nzType="primary" type="submit" [nzLoading]="loading" style="width: 100%">Sign In</button>
            </nz-form-control>
          </nz-form-item>
          <nz-form-item>
            <nz-form-control [nzOffset]="6" [nzSpan]="18">
              <button nz-button nzType="default" type="button" (click)="signInWithGoogle()" style="width: 100%">Sign in with Google</button>
            </nz-form-control>
          </nz-form-item>
        </form>
