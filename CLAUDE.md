...
- **[known-gaps.md](./.claude/rules/known-gaps.md)** — No save/load, permissive auth, no PDF export, placeholder env tokens, etc.
- **[roadmap.md](./.claude/rules/roadmap.md)** — Phase summary and link to full TODO.md

## After Each Phase

When a phase is completed, always:
1. **Update all MD files** — `TODO.md`, `CLAUDE.md`, `README.md`, and every file under `.claude/rules/` (architecture.md, commands.md, known-gaps.md, roadmap.md, style-and-patterns.md) to reflect what changed. Remove resolved gaps, add new ones, update file locations, update phase status.
